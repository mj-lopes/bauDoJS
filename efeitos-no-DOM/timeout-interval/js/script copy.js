...
// Uma função interval/timeout fica salva na lista de tarefas, esperando que todos os elementos da callstack sejam executados para só então funcionarem, sendo um dos últimos métodos executados, até mesmo o fim do script.js.
...
// O resultado é todo o código do loop ser executado instataneamente, invés de esperar o tempo de .3s para cada iteração
...
const iniciar = document.querySelector('[data-button="ativar"]');
const pausar = document.querySelector('[data-button="pausar"]');
