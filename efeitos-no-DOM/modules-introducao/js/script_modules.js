...
// Geralmente um valor por módulo. Quanto mais especifico um módulo, melhor, porém é possivel importar mais de um valor de um módulo, no exemplo abaixo.

/* 
NAMED EXPORTS
Você pode exportar mais de um valor. Quando for importar utilize as chaves {} para especificar cada valor. O nome importado deve ser igual ao exportado. --- Pois ao exportar somente um elemento, por ser especificado 'default' no módulo de origem, o nome não importa, pois sempre será usado o mesmo elemento. 
...
// - Assíncrono, os arquivos são carregados individualmente e ao mesmo tempo, porém ainda não executados em sua ordem de chamada.
