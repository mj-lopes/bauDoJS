...

{
  ...
  Object.defineProperties(moto, {
    rodas: {
      value: 2,
      configurable: false, // impede deletar e mudança de valor da propriedade - ex:. rodas
      enumarable: true, // torna enumerável
    },
    capacete: {
      value: true,
      configurable: true,
      writable: false, // impede mudança do value
    },
  })
...

{
  ...
  Object.defineProperties(moto, {
    velocidade: {
      get() {
        return this._velocidade; // é passado _(nomePropriedade) para evitar conflitos com a propriedade original
      },
      set(valor) {
...
// Object.is(obj1, obj2) verifica se os objetos são iguais e retorna true ou false, se um valor faz referencia a outro.

{
  ...
  const novaFrutas = frutas1; // novaFrutas é na verdade uma referencia ao array frutas1
...
// Object.seal() previne a adição de novas propriedades e impede que as atuais sejam deletadas, porém permite a alteração das propriedades já existentes.
...
// Todo elemento tem o método .toString(), que converterá o valor, ou tentará, para uma string, porém tbm existe o método .toString() do protótipo de Object, que retorna o tipo desse elemento, porém ao ser chamado diretamente do objeto ex:. frutas.toString() é chamada a primeira função toString. Então, caso queira puxar o tipo do objeto é necessario chamar a função diretamente do protótipo de Object - Object.prototype.toString.call(valor);
...
// EXERCÍCIOS
{
  ...
  const verificaTipagem = function(dado) {
