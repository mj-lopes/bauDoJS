...
// isNaN() é um método de Number, ou seja, não faz parte to protótipo, que verificar se um valor ou variavel é ou não um valor númerico. isInteger() verifica se é uma integral.
...
console.log(Math.max(...valores)); /// Os ... retorna cada valor de um array como um argumento para uma função
