...
// ARRAY'S E CALL
// É comum utilizarmos o call() nas funções do protótipo do construtor Array. Assim podemos estender todos os métodos de Array à objetos que se parecem com uma Array (array-like) sem a necessidade de converté-los para um array.
...

{
  ...
  // o objeto principal para funcionar, somente de paramentros
...
let totalChar = Array.prototype.reduce.call(listaP, (acumulador, item) =>{    
...
function novoElementoHTML(tag, classe, conteudo) {
  ...
  conteudo ? novoElemento.innerText = conteudo : '';
  return novoElemento;
}
console.log(novoElementoHTML('h1', 'classe-teste', 'teste'));
...
console.log(h1Titulo('Esse é o título principal')); 
}